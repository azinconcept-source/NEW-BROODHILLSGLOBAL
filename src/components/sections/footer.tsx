...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#000000] text-white pt-20 pb-10 font-sans highlight-component" data-component="Footer">
      <div className="container mx-auto px-8 max-w-[1400px]">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex flex-col">
                <span className="text-[20px] font-[900] tracking-[-0.02em] text-white leading-none uppercase" style={{ fontFamily: "'Times New Roman', serif" }}>
                  BROODHILLS
                </span>
            ...
            <p className="text-[14px] leading-[22px] text-[#CCCCCC] mb-8 max-w-[420px]">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="hover:opacity-80 transition-opacity">
                <img src={assets.instagram} alt="Instagram" className="w-8 h-8 bg-white rounded-full p-1" />
              </a>
              <a href="#" className="hover:opacity-80 transition-opacity">
                <img src={assets.youtube} alt="YouTube" className="w-8 h-8 bg-white rounded-full p-1" />
              </a>
              <a href="#" className="hover:opacity-80 transition-opacity">
                <img src={assets.facebook} alt="Facebook" className="w-8 h-8" />
              </a>
              <a href="#" className="hover:opacity-80 transition-opacity">
                <img src={assets.twitter} alt="X" className="w-8 h-8" />
              </a>
            </div>
          </div>
          <div className="md:col-span-7">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
              <div className="flex flex-col gap-4">
                <h4 className="text-[12px] font-bold tracking-widest text-white/50">LEGAL</h4>
                <a href="#" className="text-[14px] hover:text-[#6B8C14]">Legal Notes</a>
                <a href="#" className="text-[14px] hover:text-[#6B8C14]">Privacy Policy</a>
                <a href="#" className="text-[14px] hover:text-[#6B8C14]">Cookie Policy</a>
              </div>
              <div className="flex flex-col gap-4">
                <h4 className="text-[12px] font-bold tracking-widest text-white/50">FOLLOW US</h4>
                <a href="#" className="text-[14px] hover:text-[#6B8C14]">Newsletter</a>
                <a href="#" className="text-[14px] hover:text-[#6B8C14]">Podcast</a>
              </div>
              <div className="flex flex-col gap-4">
                <h4 className="text-[12px] font-bold tracking-widest text-white/50">CONTACTS</h4>
                <a href="#" className="text-[14px] hover:text-[#6B8C14]">Contact us</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-[#6B8C14]/30 flex flex-col md:flex-row justify-between items-center gap-4 text-[12px] text-white/50">
